...
public class PizzaOrdering {
    ...
    public static void main(String[] args) {
        ...
        // create 100 pizza objects: size - 'S' cheese-2 pepperoni topping - 3
        // create 100 pizza objects: size - 'M' cheese-3, pepperoni topping - 4
        // create 100 pizza objects: size - 'L' cheese-4, pepperoni topping - 5
        ...
        System.out.println("Total number of the pizza: "+pizzas.size());
        double totalPrice = 0;
